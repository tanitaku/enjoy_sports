...
/**
 * Servlet implementation class NewCreateServlet
 */
@WebServlet("/new/create")
public class NewCreateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewCreateServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            if(errors.size() > 0) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/new/new.jsp");
